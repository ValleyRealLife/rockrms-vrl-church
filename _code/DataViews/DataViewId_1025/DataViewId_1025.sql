/******************************************************************************************************************************************************
    ...
    This SQL is found in DataViewId:1025
    Currently, this DataView is named "LG NextLeaders, No RDT"
    
    References:
    - This SQL is used to sync GroupMembers of GroupId: 131748
    
    Path:
    _code/DataViews/DataViewId_1025/DataViewId_1025.sql
