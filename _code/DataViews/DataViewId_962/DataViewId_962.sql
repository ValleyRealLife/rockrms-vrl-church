/****************************************************************************************
    ...
    Note:
    The intention of this query is to identify all Placeholders that have been created 25 days ago (or older).
...
/**********
    ...
    2. From [_com_bemaservices_RoomManagement_Reservation], return all rows that have a ReservationType="PlaceHholder" and have been created 25 days ago (or older)
...
FROM
    [_com_bemaservices_RoomManagement_Reservation]
WHERE
    [CreatedDateTime] <= DATEADD(DAY, -25, GETDATE())
    AND
